...
class MessageModal extends StatelessWidget {
  ...
  Widget buildTitle(BuildContext context) {
    final tempTitle = title ?? (status == MessageModalStatus.error ? "Error!" : "Congratulations!");
  ...
  Widget build(BuildContext context) {
    ...
    final color = status == MessageModalStatus.error ? CustomColors.primary : CustomColors.success;
    final icon = status == MessageModalStatus.error ? Crosscheck.cross : Crosscheck.check;
